function [orig_aparc_lh] = import_aparc_lh_csv(filename)
%% Import data from text file.
% Script for importing data from the following text file:
%
%    /media/subin/DATA/0_FS_reorder_test/allscrbl_lhvol.csv
%
...
% filename = '/media/subin/DATA/0_FS_reorder_test/allscrbl_lhvol.csv';
delimiter = '\t';
startRow = 2;
