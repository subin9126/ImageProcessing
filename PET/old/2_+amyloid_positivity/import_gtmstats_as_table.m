function output = import_gtmstats_as_table(filename, startRow, endRow)
%IMPORTFILE1 텍스트 파일의 숫자형 데이터를 행렬로 가져옵니다.
%   GTMSTATS2020RESEARCHAPETNORESCALE = IMPORTFILE1(FILENAME) 디폴트 선택 항목의
%   텍스트 파일 FILENAME에서 데이터를 읽습니다.
%
%   GTMSTATS2020RESEARCHAPETNORESCALE = IMPORTFILE1(FILENAME, STARTROW,
%   ENDROW) 텍스트 파일 FILENAME의 STARTROW 행에서 ENDROW 행까지 데이터를 읽습니다.
%
% Example:
%   gtmstats2020researchapetnorescale = importfile1('gtmstats_2020research_apet_norescale.csv', 2, 59);
%
%    TEXTSCAN도 참조하십시오.

% MATLAB에서 다음 날짜에 자동 생성됨: 2020/05/13 14:22:03
